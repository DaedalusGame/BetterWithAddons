...
public class WaterNet extends Net {
    ...
    public static void add(IItemStack[] outputs, @NotNull IIngredient input) {
        ...
        InteractionCraftTweaker.LATE_ADDITIONS.add(new Add("WaterNet", CraftingManagerWaterNet.getInstance(),r));
    }

    @ZenMethod
    public static void remove(IItemStack input)
    {
        InteractionCraftTweaker.LATE_REMOVALS.add(new Remove("WaterNet", CraftingManagerWaterNet.getInstance(),InputHelper.toStack(input)));
    }
}
