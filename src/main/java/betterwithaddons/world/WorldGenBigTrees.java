...
public class WorldGenBigTrees extends WorldGenAbstractTree
{
    ...
    public WorldGenBigTrees(boolean notify, IBlockState log, IBlockState leaves, IPlantable sapling)
    {
        super(notify);
    ...
    private boolean validTreeLocation()
    {
        ...
        boolean isSoil = state.getBlock().canSustainPlant(state, this.world, down, net.minecraft.util.EnumFacing.UP, sapling);
